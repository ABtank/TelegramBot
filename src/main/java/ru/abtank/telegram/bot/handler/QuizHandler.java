...
import ru.abtank.telegram.repository.JpaQuestionRepository;
...
public class QuizHandler implements Handler {
    ...
    private final static Logger LOG = LoggerFactory.getLogger(QuizHandler.class);
    ...
    private List<PartialBotApiMethod<? extends Serializable>> nextQuestion(User user) {
        ...
        List<String> options = new ArrayList<String>(List.of(question.getCorrectAnswer(), question.getOptionOne(), question.getOptionTwo(), question.getOptionThree()));
        // Перемешиваем
